...
public class ProfileHeaderBehaviour extends CoordinatorLayout.Behavior<HeaderView> {
    ...
    public ProfileHeaderBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public ProfileHeaderBehaviour(Context context, AttributeSet attrs, Context mContext) {
        super(context, attrs);
